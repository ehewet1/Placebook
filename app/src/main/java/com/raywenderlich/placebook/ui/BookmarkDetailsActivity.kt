...
class BookmarkDetailsActivity : AppCompatActivity(),
   ...
   override fun onCreate(savedInstanceState: android.os.Bundle?)
    ...
    private fun getImageWithPath(filePath:String)=ImageUtils.decodeFileToSize(
        filePath, resources.getDimensionPixelSize(R.dimen.default_image_width),
    ...
    private fun populateCategoryList(){
        ...
        val resourcedId = bookmarkDetailsViewModel.
        getCategoryResourceId((bookmarkView.category))

        resourcedId?.let { databinding.imageViewCategory.setImageResource(it) }
